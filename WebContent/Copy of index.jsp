...
<body id="page-top" class="index">
	...
	<header>
		<div class="container">
			<div class="intro-text">
				<div class="intro-lead-in modified">Welcome To Our Website!</div>
				<div class="intro-heading modified">It's Nice To Meet You</div>
	...
	<section id="about">
		<div class="container container-new">
			<div class="row">
				<div class="col-lg-12">
					<h2 class="section-heading">About CKD</h2>
					<!-- <h3 class="section-subheading text-muted">Lorem ipsum dolor sit amet consectetur.</h3> -->
					<p>CKD is a commonsense knowledge base containing a new kind of
						commonsense knowledge. This knowledge is useful in developing
						...
						below explains, in detail, the kind of commonsense knowledge
						present in this knowledge base and how it is applicable.</P>
					<p>
						Let us consider an example that represents both deep question
						answering and hard co-reference resolution. Here, we are given a
						sentence and a question on it. The answer to the question depends
						...
						These examples are inspired from <a
					...
					<p>
						...
						Z <b>THEN</b> Z = B <br> It is explained with the help of the
						picture below.
					</p>
					<img src="./img/test.png" alt="commonsense knowledge">
					<p>
						In Other Words; <br> <b>If</b> bully event <b>causes</b>
						rescue event <br> <b>then</b> <i>recipient</i> of bully event
						= <i>recipient</i> of rescued event
					</p>
					<p>
						CKB contains above mentioned kind of commonsense knowledge. As
						perceived from the example of the commnsense knowledge above,
						there are <br> <br>The knowledge base supports seven
						different types of queries based on the commonsense mentioned
						above. The queries are
					</p>
					<ul>
						<li>Event1=E1, REL=R1, Event2=E2, Slot1=S1, Slot2=S2,
							Commonsense=?<br> Hello
						</li>

						<li>Event1=E1, REL=R1, Event2=?, Slot1=S1, Slot2=S2,
							Commonsense=?</li>
						<li>Event1=?, REL=R1, Event2=E2, Slot1=S1, Slot2=S2,
							Commonsense=?</li>
						<li>Event1=E1, REL=?, Event2=E2, Slot1=S1, Slot2=S2,
							Commonsense=?</li>
						<li>Event1=E1, REL=R1, Event2=E2, Slot1=?, Slot2=S2,
							Commonsense=?</li>
						<li>Event1=E1, REL=R1, Event2=E2, Slot1=S1, Slot2=?,
							Commonsense=?</li>
						<li>Event1=E1, REL=R1, Event2=E2, Slot1=?, Slot2=?,
							Commonsense=?</li>
					</ul>
