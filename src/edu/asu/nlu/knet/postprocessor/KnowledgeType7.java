 ...
 *
 */
public class KnowledgeType7 extends KnowledgeType{
	/**
	 * X.trait=true/false may entail execution of EVENT [ARG*: X; ARG*: Y] 
	 */
	...
	public String getReadableKnowledge(){
		...
		result+=" may entail execution of " + event +"["+eventRel + ": X";
	...
	public String getNeo4JCreateQuery(){
		...
		result += "(n1)-[r01 {name: 'may_entail', id: '01']->(n"+nodeIndexMap.size()+"),";
