 ...
 *
 */
public class KnowledgeType1 extends KnowledgeType{

	/**
	 * execution of EVENT1 [ARG*: X; ARG*: Y] may cause execution of EVENT2 [ARG*: X; ARG*: Z]
	 */
	...
	public String toString(){
		...
		result+="] may cause execution of " + event2 +"["+event2Rel + ": X";
	...
	public String getNeo4JCreateQuery(){
		...
		result += "(n1)-[r01:may_cause {name: 'may_cause', id: '01'}]->(n"+event2Index+"),";
