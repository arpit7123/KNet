 ...
 *
 */
public class KnowledgeType2 extends KnowledgeType{
	
	/**
	 * X.trait=true/false may prevent execution of EVENT [ARG*: X; ARG*: Y] 
	 */
	...
	public String getReadableKnowledge(){
		...
		result+=" may prevent execution of " + event +"["+eventRel + ": X";
	...
	public String getNeo4JCreateQuery(){
		...
		result += "(n1)-[r01 {name: 'may_prevent', id: '01']->(n"+nodeIndexMap.size()+"),";
