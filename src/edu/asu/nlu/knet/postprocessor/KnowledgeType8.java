 ...
 *
 */
public class KnowledgeType8 extends KnowledgeType{
	/**
	 * execution of EVENT1 [ARG*: X; ARG*: Y] may entail execution of EVENT2 [ARG*: X; ARG*: Z]
	 */
	...
	public String getReadableKnowledge(){
		...
		result+="] may entail execution of " + event2 +"["+event2Rel + ": X";
	...
	public String getNeo4JCreateQuery(){
		...
		result += "(n1)-[r01:may_entail {name: 'may_entail', id: '01'}]->(n"+event2Index+"),";
