 ...
 *
 */
public class KnowledgeType6 extends KnowledgeType {

	/**
	 * execution of EVENT1 [ARG*: X; ARG*: Y] may follow execution of EVENT2 [ARG*: X; ARG*: Z]
	 */
	...
	public String getReadableKnowledge(){
		...
		result+="] may follow execution of " + event2 +"["+event2Rel + ": X";
	...
	public String getNeo4JCreateQuery(){
		...
		result += "(n1)-[r01:may_follow {name: 'may_follow', id: '01'}]->(n"+event2Index+"),";
